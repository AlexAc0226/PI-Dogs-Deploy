...
function validate(e){
  ...
  else if(e.heightMax < e.heightMin) error.heightMax = 'La altura maxima del perro no puede ser menor a la altura minima'
  ...
  else if(e.weightMax < e.weightMin) error.weightMax = 'El peso maxima del perro no puede ser menor al peso minimo'
  ...
  else if(e.yearOfLifeMax < e.yearOfLifeMin) error.yearOfLifeMax = 'La estimació de vida maxima del perro no puede ser menor a la minima'
